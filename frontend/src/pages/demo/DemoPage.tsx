  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Demo Video Section */}
        <div className="bg-white rounded-xl shadow-sm p-8 mb-16 text-center dark:bg-slate-800 border border-gray-200 dark:border-slate-700">
          <div className="max-w-4xl mx-auto">
            <div className="bg-gray-200 border-2 border-dashed rounded-xl w-full h-96 flex items-center justify-center mb-8 dark:bg-slate-700 dark:border-slate-600">
              <div className="text-center">
                <Play className="h-16 w-16 text-gray-400 mx-auto mb-4 dark:text-slate-500" />
                <p className="text-gray-500 dark:text-slate-400">Interactive Demo Video</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => {
              ...
              return (
                <div 
                  key={index} 
                  className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition dark:bg-slate-800 dark:hover:shadow-slate-800/50 border border-gray-200 dark:border-slate-700"
                >
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-8 text-center text-white mb-16 dark:from-indigo-700 dark:to-purple-700">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Try Our Interactive Demo</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="bg-indigo-800 text-white px-6 py-3 rounded-lg font-semibold hover:bg-indigo-900 transition dark:bg-indigo-900 dark:hover:bg-indigo-800">
        ...
        {/* CTA Section */}
        <div className="bg-white rounded-xl shadow-sm p-8 text-center dark:bg-slate-800 border border-gray-200 dark:border-slate-700">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Ready to Transform Your Legal Workflow?</h2>
