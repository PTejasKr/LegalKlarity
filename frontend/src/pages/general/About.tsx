    ...
    <div className="min-h-screen bg-black py-28 px-4 md:px-20">
      ...
      >
        <div className="flex items-center mb-4">
          ...
          <h2 className="text-2xl font-heading font-semibold text-yellow-500">Our Mission</h2>
        </div>
      ...
      >
        <div className="flex items-center mb-4">
          ...
          <h2 className="text-2xl font-heading font-semibold text-yellow-500">Our Vision</h2>
        </div>
        <p className="text-gray-300 font-body leading-relaxed">
      ...
      >
        ...
        <p className="text-lg font-body text-gray-300 text-center mb-12 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <motion.div
            ...
            className="bg-gray-900 rounded-2xl p-6 border border-gray-700 text-center shadow-xl"
          >
            <div className="text-5xl font-bold text-yellow-500 mb-2">80%</div>
            <div className="text-xl font-semibold text-white mb-2">of People</div>
            <p className="text-gray-300">Don't fully understand the contracts they sign, leading to costly mistakes</p>
          </motion.div>
          ...
          >
            ...
            <div className="text-xl font-semibold text-white mb-2">Average Loss</div>
            <p className="text-gray-300">Per person due to unfavorable contract terms they didn't understand</p>
          </motion.div>
          ...
          >
            ...
            <div className="text-xl font-semibold text-white mb-2">Wasted Daily</div>
            <p className="text-gray-300">Trying to decode legal language that could be explained simply</p>
          </motion.div>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="max-w-4xl mx-auto mb-16 bg-gray-900 shadow-xl rounded-2xl p-8 border border-gray-700"
      >
        <h2 className="text-2xl font-heading font-semibold text-yellow-500 mb-6">The Traditional Approach Isn't Working</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gray-800 rounded-xl p-6">
            <h3 className="text-xl font-semibold text-white mb-3">Legal Consultation Barriers:</h3>
          ...
          <div className="bg-gray-800 rounded-xl p-6">
            <h3 className="text-xl font-semibold text-white mb-3">Current Solutions Fall Short:</h3>
            <ul className="text-gray-300 space-y-2">
      ...
      >
        <div className="inline-block px-4 py-2 rounded-full bg-gray-900 border border-yellow-600 text-yellow-500 font-semibold text-xs tracking-wide uppercase shadow-sm mb-6">
          AI-Powered Legal Document Demystification
        </div>
        <h2 className="text-3xl font-heading font-bold text-yellow-500 mb-6">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            <p className="text-gray-300">Get results in seconds, not days or weeks</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-white mb-3">Affordable Access</h3>
            <p className="text-gray-300">99% cheaper than traditional legal consultation</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-300">Tailored analysis based on your role and needs</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-300">Available in Hindi, English, and regional languages</p>
          </motion.div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <motion.div
            ...
            className="bg-gray-900 rounded-2xl p-6 border border-gray-700 text-center shadow-xl"
          >
            <div className="text-2xl font-bold text-white mb-2">Time Saved</div>
          ...
          <motion.div
            ...
            className="bg-gray-900 rounded-2xl p-6 border border-gray-700 text-center shadow-xl"
          >
            <div className="text-2xl font-bold text-white mb-2">Risk Prevention</div>
          ...
          <motion.div
            ...
            className="bg-gray-900 rounded-2xl p-6 border border-gray-700 text-center shadow-xl"
          >
            <div className="text-2xl font-bold text-white mb-2">User Satisfaction</div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-white mb-1">Karan Tripathi</h3>
            <p className="text-yellow-500 mb-2">Founder & CEO</p>
            <p className="text-gray-300 text-sm">Visionary leader with a passion for making legal services accessible to everyone in India.</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-white mb-1">Saurav Sankar</h3>
            <p className="text-yellow-500 mb-2">Co-Founder</p>
            <p className="text-gray-300 text-sm">Strategic thinker focused on building scalable solutions for legal document analysis.</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-white mb-1">Tejash</h3>
            <p className="text-yellow-500 mb-2">CTO</p>
            <p className="text-gray-300 text-sm">Technical expert driving innovation in AI-powered legal document processing.</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-white mb-1">Divya</h3>
            <p className="text-yellow-500 mb-2">Team Member</p>
            <p className="text-gray-300 text-sm">Dedicated professional contributing to frontend development and user experience.</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-white mb-1">Shruthi</h3>
            <p className="text-yellow-500 mb-2">Team Member</p>
            <p className="text-gray-300 text-sm">Valuable contributor to backend systems and database management.</p>
          </motion.div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          >
            ...
            <div className="text-xl font-bold text-white mb-2">TechCrunch Disrupt</div>
            <p className="text-gray-300">Winner - Best AI Innovation 2024</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-300">Documents analyzed and counting</p>
          </motion.div>
          ...
          >
            ...
            <div className="text-3xl font-bold text-white mb-2">50+ Cities</div>
            <p className="text-gray-300">Across India trust LegalKlarity</p>
          </motion.div>
      ...
      <motion.div
        ...
        className="max-w-4xl mx-auto mt-20 text-center bg-gray-900 rounded-2xl p-8 shadow-xl border border-gray-700"
      >
        <h2 className="text-3xl font-heading font-bold text-yellow-500 mb-4">
          Join Our Mission
        </h2>
        ...
        <div className="flex flex-col sm:flex-row sm:justify-center sm:gap-6 sm:items-center">
          ...
          <Button 
            ...
            className="bg-transparent text-yellow-500 hover:bg-yellow-500/10 font-bold px-8 py-3 rounded-full shadow-lg transition text-lg tracking-wide border-2 border-yellow-500 inline-flex items-center gap-2 justify-center"
          >
