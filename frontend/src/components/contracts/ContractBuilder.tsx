...
export default function ContractBuilder() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6 w-full">
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Contract Builder</h2>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="lg:w-1/3">
          ...
          {/* Add Custom Clause */}
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-3">Add Custom Clause</h3>
        ...
        <div className="lg:w-2/3">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-xl font-semibold text-gray-800">Contract Preview</h3>
          ...
          <div className="border rounded-lg overflow-hidden">
            <div className="bg-gray-50 p-4 border-b">
              <h1 className="text-2xl font-bold text-center text-gray-800">{contractName}</h1>
            </div>
