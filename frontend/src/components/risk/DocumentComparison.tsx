...
export default function DocumentComparison() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6 w-full">
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Document Comparison</h2>
                ...
                <div className="grid grid-cols-2 max-h-96 overflow-y-auto">
                  <div className="p-3 border-r">
                    <div className="space-y-2">
                      <div className="p-2 bg-green-50 rounded">Clause 1: Parties - Added in Document 2</div>
                      <div className="p-2">Clause 2: Term - No changes</div>
                      <div className="p-2 bg-yellow-50 rounded">Clause 3: Payment - Modified in Document 2</div>
                      <div className="p-2">Clause 4: Termination - No changes</div>
                      <div className="p-2 bg-red-50 rounded">Clause 5: Confidentiality - Removed in Document 2</div>
                    </div>
                  </div>
                  <div className="p-3">
                    <div className="space-y-2">
